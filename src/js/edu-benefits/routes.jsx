...
const routes = [
  ...
  <Route
      ...
      key="veteranInformation"
      form="veteranInformation"
  ...
  <Route
      ...
      key="benefitsSelection"
      form="benefitsSelection"
  ...
  <Route
      ...
      key="benefitsRelinquishment"
      form="benefitsRelinquishment"
      path="/benefits-eligibility/benefits-relinquishment"
      chapter={chapterNames.benefitsEligibility}
      depends={(form) => {
        return form.benefitsSelection
          && form.benefitsSelection.values
          && form.benefitsSelection.values.benefitsChosen
          && form.benefitsSelection.values.benefitsChosen.some(ben => ben === 'chapter33');
      }}
