...
import { isValidYear, validateIfDirty, isValidMonetaryValue } from '../../utils/validations';
    ...
    const formFields = (
      <div className="row">
        ...
        <div className="columns small-8">
          <ErrorableTextInput
              errorMessage={validateIfDirty(scholarship.amount, isValidMonetaryValue) ? undefined : 'Please enter the amount received.'}
              validation={validateIfDirty(scholarship.amount, isValidMonetaryValue)}
