...
const ui = {
  ...
  pages: {
    ...
    '/benefits-eligibility/benefits-selection': {
      complete: false,
      verified: false,
      fields: ['benefitsRelinquished', 'chapter30', 'chapter32', 'chapter33', 'chapter1606', 'unknownBenefit', 'previouslyFiledClaimWithVa', 'benefitsRelinquishedDate', 'applyingUsingOwnBenefits']
    },
